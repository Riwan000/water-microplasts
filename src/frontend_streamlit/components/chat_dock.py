...
def render(
    ...
    Args:
        ...
        height: Fixed pixel height of the chat panel. The chat input pins to
            the bottom of this container instead of the whole page, so a
            growing conversation scrolls in place rather than the page.
    """
